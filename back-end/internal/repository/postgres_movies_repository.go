...
func (m *PostgresMoviesRepository) GetAllMovies(genres ...int) ([]*models.Movie, error) {
...
func (m *PostgresMoviesRepository) UpdateMovie(movie models.Movie) error {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (m *PostgresMoviesRepository) DeleteMovieById(id int) error {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
